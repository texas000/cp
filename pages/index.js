  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta property="og:description" content="James Worldwide, Adding Values to Your Cargo!"></meta>
            ...
            <div className="col-md-5">
              <div className="mt-md-4">
                ...
                <a className="btn btn-success">
                  Dashboard <i className="mdi mdi-arrow-right ms-1"></i>
                </a>
                </Link>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="text-center p-3">
                ...
                <h4 className="mt-3">Ocean Freight</h4>
            ...
            <div className="col-lg-4">
              <div className="text-center p-3">
                ...
                <h4 className="mt-3">Air Freight</h4>
                <p className="text-muted mt-2 mb-0">
          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="text-center p-3">
                ...
                <h4 className="mt-3">Warehouse</h4>
                <p className="text-muted mt-2 mb-0">
      ...
      {/* CONTACT */}
      <section className="py-5 bg-light-lighten border-top border-bottom border-light" id="contact">
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="text-center">
